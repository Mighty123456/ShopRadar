...
class RoleSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const userBlueHover = Color(0xFF2979FF); // More visible blue for hover
          ...
          children: [
            Expanded(
              child: _RoleOption(
                ...
                selectedColor: primaryBlue, // Changed from gray to blue
                selectedBg: lightBlueBg, // Changed from lightGrayBg to lightBlueBg
                selectedBgHover: lightBlueBgHover, // Changed to blue hover
                unselectedColor: gray,
                unselectedBg: lightGrayBg,
                unselectedBgHover: userBlueHover.withValues(alpha: 0.08), // More visible hover
                selectedBorder: primaryBlue, // Changed from lightGrayBorder to blue
